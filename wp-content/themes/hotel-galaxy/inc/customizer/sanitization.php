 ...
 */
function hotelgalaxy_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function hotelgalaxy_sanitize_html( $html ) {
 ...
 */
function hotelgalaxy_sanitize_image( $image, $setting ) {
 ...
 */
function hotelgalaxy_sanitize_nohtml( $nohtml ) {
 ...
 */
function hotelgalaxy_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function hotelgalaxy_sanitize_range_value( $number, $setting ) {
 ...
 */
function hotelgalaxy_sanitize_select( $input, $setting ) {
 ...
 */
function hotelgalaxy_sanitize_url( $url ) {
...
function hotelgalaxy_sanitize_sortable( $val, $setting ) {
...
function hotelgalaxy_sanitize_typography_fonts( $input ) {
	$standard = hotelgalaxy_font_selector_get_standard_fonts();
	$google = hotelgalaxy_font_selector_get_google_fonts_array();
...
// category
function hotelgalaxy_blog_category( $value ) {
