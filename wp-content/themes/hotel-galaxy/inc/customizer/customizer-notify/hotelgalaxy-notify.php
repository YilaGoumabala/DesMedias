...
class Hotelgalaxy_Customizer_Notify {
	...
	public function hotelgalaxy_plugin_notification_customize_register( $wp_customize ) {
		...
		require HOTEL_PARENT_INC_DIR . '/customizer/customizer-notify/hotelgalaxy-notify-section.php';

		$wp_customize->register_section_type( 'Hotelgalaxy_Customizer_Notify_Section' );

		$wp_customize->add_section(
			new Hotelgalaxy_Customizer_Notify_Section(
				$wp_customize,
